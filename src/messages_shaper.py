...
def shape_simple_weather_message(data):
    ...
    formed_data = ("{date_symbol} Date: {date}\n"
        ...
        .format(date_symbol=constants.EMOJI_CALENDAR, date=data['date'],
                termometer_symbol=constants.EMOJI_THERMOMETER,
                temperature=data['low'] + constants.EMOJI_CELSIUS + " --- " + data['high'] \
                    + constants.EMOJI_CELSIUS,
...
def shape_complex_weather_message(data):
    ...
    formed_wind_data = ("      {wind_symbol} Wind:\n"
        ...
        .format(wind_symbol=constants.EMOJI_WIND, wind_temperature_symbol=constants.EMOJI_THERMOMETER,
                chill=data['wind']['chill'], direction_symbol=constants.EMOJI_DIRECTION,
                direction=data['wind']['direction'], speed_symbol=constants.EMOJI_FOG,
    ...
    formed_atmosphere_data = ("      {atmosphere_symbol} Atmosphere:\n"
        ...
        .format(atmosphere_symbol=constants.EMOJI_ATMOSPHERE, humidity_symbol=constants.EMOJI_DRIZZLE,
                humidity=data['atmosphere']['humidity'] + '%', visibility_symbol=constants.EMOJI_VISIBILITY,
                visibility=data['atmosphere']['visibility'], pressure_symbol=constants.EMOJI_PRESSURE,
    ...
    formed_astronomy_data = ("      {astronomy_symbol} Astronomy:\n"
        ...
        .format(astronomy_symbol=constants.EMOJI_ASTRONOMY, sunrise_symbol=constants.EMOJI_SUNRISE,
                sunrise=data['astronomy']['sunrise'], sunset_symbol=constants.EMOJI_SUNSET,
                sunset=data['astronomy']['sunset'])

    formed_data = [
        formed_wind_data,
        formed_atmosphere_data,
        formed_astronomy_data]
